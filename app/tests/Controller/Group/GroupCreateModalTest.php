...
class GroupCreateModalTest extends AdminTestCase
{
    ...
    public function testPageForGuestUser(): void
    {
        ...
        $request = $this->createJsonRequest('GET', '/modals/groups/create');
        ...
        $this->assertSame('/account/sign-in?redirect=%2Fmodals%2Fgroups%2Fcreate', $response->getHeaderLine('Location'));
    }
