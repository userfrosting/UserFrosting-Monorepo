...
class RoleEditModalTest extends AdminTestCase
{
    use RefreshDatabase;
    use WithTestUser;
    ...
    public function testPageForGuestUser(): void
    {
        ...
        $request = $this->createJsonRequest('GET', '/modals/roles/edit');
        ...
        $this->assertSame('/account/sign-in?redirect=%2Fmodals%2Froles%2Fedit', $response->getHeaderLine('Location'));
    }
    ...
    public function testPage(): void
    {
        ...
        $permission = new Permission([
            ...
            'conditions' => "subset(fields,['name', 'slug', 'description'])",
        ]);
        $permission->save();
